...
/**
 * BpJPlanRepairDetail entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "BP_J_PLAN_REPAIR_DETAIL", schema = "POWER")
public class BpJPlanRepairDetail implements java.io.Serializable {
	...
	/** default constructor */
	public BpJPlanRepairDetail() {
	}

	/** minimal constructor */
	public BpJPlanRepairDetail(Long planDetailId) {
		this.planDetailId = planDetailId;
	}

	/** full constructor */
	public BpJPlanRepairDetail(Long planDetailId, Long planDepId,
	...
	@Column(name = "PLAN_DEP_ID", precision = 10, scale = 0)
