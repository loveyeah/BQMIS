...
/**
 * BpJItemplanDepMain entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "BP_J_ITEMPLAN_DEP_MAIN")
public class BpJItemplanDepMain implements java.io.Serializable {
	...
	/** default constructor */
	public BpJItemplanDepMain() {
	}

	/** minimal constructor */
	public BpJItemplanDepMain(Long depMainId) {
		this.depMainId = depMainId;
	}

	/** full constructor */
	public BpJItemplanDepMain(Long depMainId, Date month, Long workflowNoPlan,
