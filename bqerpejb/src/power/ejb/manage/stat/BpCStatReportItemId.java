...
/**
 * BpCStatReportItemId entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Embeddable
public class BpCStatReportItemId implements java.io.Serializable {
	...
	/** default constructor */
	public BpCStatReportItemId() {
	}

	/** full constructor */
	public BpCStatReportItemId(Long reportCode, String itemCode) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BpCStatReportItemId))
			return false;
		BpCStatReportItemId castOther = (BpCStatReportItemId) other;
