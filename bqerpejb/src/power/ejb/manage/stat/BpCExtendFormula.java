...
/**
 * BpCExtendFormula entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "BP_C_EXTEND_FORMULA")
public class BpCExtendFormula implements java.io.Serializable {

	// Fields

	private BpCExtendFormulaId id;
	...
	/** default constructor */
	public BpCExtendFormula() {
	}

	/** minimal constructor */
	public BpCExtendFormula(BpCExtendFormulaId id) {
		this.id = id;
	}

	/** full constructor */
	public BpCExtendFormula(BpCExtendFormulaId id, String formulaContent,
	...
	public BpCExtendFormulaId getId() {
		return this.id;
	}

	public void setId(BpCExtendFormulaId id) {
		this.id = id;
	}
