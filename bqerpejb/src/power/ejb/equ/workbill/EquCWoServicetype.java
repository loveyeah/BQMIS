...
/**
 * EquCWoServicetype entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "EQU_C_WO_SERVICETYPE", schema = "POWER")
public class EquCWoServicetype implements java.io.Serializable {
	...
	/** default constructor */
	public EquCWoServicetype() {
	}

	/** minimal constructor */
	public EquCWoServicetype(Long id) {
		this.id = id;
	}

	/** full constructor */
	public EquCWoServicetype(Long id, Long pid, String typename,
