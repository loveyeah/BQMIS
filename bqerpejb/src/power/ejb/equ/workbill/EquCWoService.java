 ...
 */
@Entity
@Table(name = "EQU_C_WO_SERVICE", schema = "POWER")
public class EquCWoService implements java.io.Serializable {
	...
	/** default constructor */
	public EquCWoService() {
	}

	/** minimal constructor */
	public EquCWoService(Long id) {
		this.id = id;
	}

	/** full constructor */
	public EquCWoService(Long id, String code, String name, String type,
