...
/**
 * EquJStepdocuments entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@Table(name="EQU_J_STEPDOCUMENTS"
    ,schema="POWER"
)

public class EquJStepdocuments  implements java.io.Serializable {
    ...
    /** default constructor */
    public EquJStepdocuments() {
    }

	/** minimal constructor */
    public EquJStepdocuments(Long id, String woCode, String enterprisecode) {
        this.id = id;
        this.woCode = woCode;
    ...
    /** full constructor */
    public EquJStepdocuments(Long id, String woCode, String fileCode, String fileName, String fileType, Double fileSize, String relateFile, String filePath, String enterprisecode, String ifUse) {
        this.id = id;
        this.woCode = woCode;
