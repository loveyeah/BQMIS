...
/**
 * HrJWorkattendanceId entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Embeddable
public class HrJWorkattendanceId implements java.io.Serializable {
	...
	/** default constructor */
	public HrJWorkattendanceId() {
	}

	/** full constructor */
	public HrJWorkattendanceId(Long empId, Date attendanceDate) {
		this.empId = empId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HrJWorkattendanceId))
			return false;
		HrJWorkattendanceId castOther = (HrJWorkattendanceId) other;
