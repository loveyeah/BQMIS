...
/**
 * AbstractKksCSteam entity provides the base persistence definition of the
 * KksCSteam entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractKksCSteam implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractKksCSteam() {
	}

	/** minimal constructor */
	public AbstractKksCSteam(String qljNumber) {
		this.qljNumber = qljNumber;
	}

	/** full constructor */
	public AbstractKksCSteam(String qljNumber, String qljSys,
			String qljEntiretyType, String qljModel, String qljSpecifiedPower,
			String qljMaxPower, String qljSpecifiedSpeed,
			String qljMainSteamTemper, String qljMainSteamPressure,
			String qljPushair, String qljHeatRat, String qljEnterTemper,
			String qljReheatSteamTemper, String qljReheatSteamPressure,
			Date qljMakerData, String qljMakerName, String qljMakerNumber) {
		this.qljNumber = qljNumber;
		this.qljSys = qljSys;
