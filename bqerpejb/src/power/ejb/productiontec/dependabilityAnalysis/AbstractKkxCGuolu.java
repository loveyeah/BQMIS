...
/**
 * AbstractKkxCGuolu entity provides the base persistence definition of the
 * KkxCGuolu entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractKkxCGuolu implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractKkxCGuolu() {
	}

	/** minimal constructor */
	public AbstractKkxCGuolu(String glNumber) {
		this.glNumber = glNumber;
	}

	/** full constructor */
	public AbstractKkxCGuolu(String glNumber, String glSys,
			String glEntiretyType, String glType, String glEdzfl,
			String glZzqgdwd, String glZzqhdyl, String glZrzqll,
			String glRkzrqedwd, String glCkzrqedwd, String glRkzrqedyl,
			String glCkzrqedyl, String glWater, String glRunPattern,
			String glFuel, String glCoal, String glPush, String glBurn,
			String glStove, String glAir, String glHotAir, String glSmoke,
			String glEfficiency, String glMakerName, String glMakerNumber,
			Date glMakerData) {
		this.glNumber = glNumber;
		this.glSys = glSys;
