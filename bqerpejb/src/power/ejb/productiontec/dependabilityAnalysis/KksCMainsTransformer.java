...
/**
 * KksCMainsTransformer entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "KKS_C_MAINS_TRANSFORMER")
public class KksCMainsTransformer implements java.io.Serializable {
	...
	/** default constructor */
	public KksCMainsTransformer() {
	}

	/** minimal constructor */
	public KksCMainsTransformer(String zbyqNumber) {
		this.zbyqNumber = zbyqNumber;
	}

	/** full constructor */
	public KksCMainsTransformer(String zbyqNumber, String zbyqSys,
