...
/**
 * PtKkxCFjstate entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "PT_KKX_C_FJSTATE")
public class PtKkxCFjstate implements java.io.Serializable {
	...
	/** default constructor */
	public PtKkxCFjstate() {
	}

	/** minimal constructor */
	public PtKkxCFjstate(Long jzztId) {
		this.jzztId = jzztId;
	}

	/** full constructor */
	public PtKkxCFjstate(Long jzztId, String jzztCode, String jzztName,
