...
/**
 * KksCElectricGenerator entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "KKS_C_ELECTRIC_GENERATOR")
public class KksCElectricGenerator implements java.io.Serializable {
	...
	/** default constructor */
	public KksCElectricGenerator() {
	}

	/** minimal constructor */
	public KksCElectricGenerator(String fdjNumber) {
		this.fdjNumber = fdjNumber;
	}

	/** full constructor */
	public KksCElectricGenerator(String fdjNumber, String fdjSys,
