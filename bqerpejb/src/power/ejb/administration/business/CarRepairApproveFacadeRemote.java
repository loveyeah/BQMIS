...
@Remote
public interface CarRepairApproveFacadeRemote {
	 ...
	 * 插入DB操作
	 */
	public void saveDBOperate(String workCode,AdJCarwh saveAdJCarwhEntity,List<AdJCarwhMx> saveAdJCarwhList,AdJCarfile updateAdjCarFileEntity,List<AdJCarwhList> saveAdJCarwhListList)throws SQLException,DataChangeException;
	
	/**
	 * 车辆维修申请点击修改的DB操作
	 * @param updateAdJCarwhEntity 车辆维护更新bean
	 * @param updateAdJCarwhList 车辆维修明细更新用bean
	 * @param deleteAdJCarwhList 车辆维修明细删除用bean
	 * @param saveAdJCarwhList 车辆维修明细新增用bean
	 * @param updateAdjCarFileEntity 车辆档案更新用bean
	 * @param updateAdJCarwhListList 材料明细表更新用bean
	 * @param deleteAdJCarwhListList 材料明细表删除用bean
	 * @param saveAdJCarwhListList 材料明细表新增用bean
	 */
