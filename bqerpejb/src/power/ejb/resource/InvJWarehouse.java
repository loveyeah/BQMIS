 ...
 */
@Entity
@Table(name = "INV_J_WAREHOUSE")
public class InvJWarehouse implements java.io.Serializable {

	// Fields

	private Long warehouseInvId;
	...
	/** default constructor */
	public InvJWarehouse() {
	}

	/** minimal constructor */
	public InvJWarehouse(Long warehouseInvId, Long materialId, String whsNo,
			Double openBalance, Double receipt, Double adjust, Double issue,
			String lastModifiedBy, Date lastModifiedDate,
			String enterpriseCode, String isUse) {
		this.warehouseInvId = warehouseInvId;
	...
	/** full constructor */
	public InvJWarehouse(Long warehouseInvId, Long materialId, String whsNo,
			Double monthAmount, Double monthCost, Double yearAmount,
			Double yearCost, Double openBalance, Double receipt, Double adjust,
			Double issue, Double reserved, String lastModifiedBy,
	...
	// Property accessors
	@Id
	@Column(name = "WAREHOUSE_INV_ID", unique = true, nullable = false, precision = 10, scale = 0)
	public Long getWarehouseInvId() {
		return this.warehouseInvId;
	}

	public void setWarehouseInvId(Long warehouseInvId) {
		this.warehouseInvId = warehouseInvId;
	}
