...
<title>选择人员测试</title>
	<script >
		function chooseWorkerSingle()
		{
			...
			var rvo = window.showModalDialog('workerByDept2.jsp', args,'dialogWidth:550px;dialogHeight:300px;directories:yes;help:no;status:no;resizable:no;scrollbars:yes;');
