...
Ext.onReady(function() {
 ...
 //-----------------------------------   
    ...
    var headTbar = new Ext.Toolbar({
        region : 'north',
//      border:false,
        items : ['月份：',monthDate,btnPrint,exportbtn]
    });
...
//        border : false,
    ...
    function exportbtn() {
		...
		url = "/powerrpt/frameset?__report=hfmis/receiveIssuesWh.rptdesign";
...
//        strReportAdds="/powerrpt/report/webfile/receiveIssues.jsp?month="+strMonth;
    	strReportAdds="/powerrpt/report/webfile/receiveIssuesWh.jsp?month="+strMonth;
