...
Ext.onReady(function() {
	// 05/08/09 16:23 标记是否可以响应回车 yiliu
	var flagEnter = true;
    ...
    var graphButton = new Ext.Button({
        text : "图形展示",
        handler : function(){  
		var url= application_base_path + "workflow/manager/flowshow/flowshow.jsp?flowCode="+flowCode;
        	window.open(url);
		}
    });
    // 查看审批记录
...
//                            params.push("&factoryType=bq"); 
		                    ...
		                    var dateMemo = getPlanDateInfoByDate(mrTypeId, nowDate);
                             params.push("&dateMemo="+dateMemo);
