...
Ext.onReady(function() {
	...
	var acceptanceLevel = arg.acceptanceLevel;
	var entryId = arg.entryId;
	var acceptId = arg.acceptId;
	...
	var lblApprove = new Ext.form.Label({
		id : 'lblApprove',
		text : '相关领导审批',
		style : "color:blue;font-size:30px;line-height:100px;padding-left:140px;font-weight:bold"
	});
	...
	function getCurrentSteps() {
		...
		Ext.Ajax.request({
			...
			params : {
				...
				jsonArgs : "{'ACCEPTANCE_LEVEL':" + flag + "}"
			},
			success : function(result, request) {
				...
				Ext.lib.Ajax.request('POST',
						'managecontract/contractApproveCheckUser.action', {
							success : function(action) {
								...
								if (result) {
									Ext.Ajax.request({
										url : 'manageplan/repairAcceptApprove.action',
										waitMsg : '正在保存数据...',
										method : 'post',
										params : {
											entryId : entryId,
