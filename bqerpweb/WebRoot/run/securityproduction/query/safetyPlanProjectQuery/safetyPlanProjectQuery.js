	...
	function updateRecord() {
		...
		if (recordslen > 1) {
			...
			if (!rec) {
				...
				win.setTitle("查看安措项目计划明细");
				win.show();
				Ext.get('securityPlanId').dom.value = rec
						.get('spjs.securityPlanId');
				Ext.get('planName').dom.value = rec.get('spjs.planName') == null
						? ""
						: rec.get('spjs.planName');
				Ext.get('planBasis').dom.value = rec.get('spjs.planBasis') == null
						? ""
						: rec.get('spjs.planBasis');
				Ext.get('fee').dom.value = rec.get('spjs.fee') == null
						? ""
						: numberFormat(rec.get('spjs.fee'));
				Ext.get('year').dom.value = rec.get('spjs.year') == null
						? ""
						: rec.get('spjs.year');
				Ext.get('finishDate').dom.value = rec.get('finishDate') == null
						? ""
						: rec.get('finishDate');
				Ext.get('spjs.chargeBy').dom.value = rec.get('spjs.chargeBy')
				Ext.get('chargeBy').dom.value = rec.get('spjs.chargeBy') == null
						? ""
						: rec.get('chargeName');
				Ext.get('chargeDep').dom.value = rec.get('chargeDepName') == null
						? ""
						: rec.get('chargeDepName');
				Ext.get('memo').dom.value = rec.get('spjs.memo') == null
						? ""
						: rec.get('spjs.memo');
				Ext.get('spjs.fillBy').dom.value = rec.get('spjs.fillBy')
				Ext.get('fillBy').dom.value = rec.get('fillName') == null
						? ""
						: rec.get('fillName');
				Ext.get('fillDepH').dom.Value = rec.get('spjs.fillDep')
				Ext.get('fillDep').dom.value = rec.get('fillDepName') == null
						? ""
						: rec.get('fillDepName');
				Ext.get('fillDate').dom.value = rec.get('fillDate') == null
						? ""
						: rec.get('fillDate');
				 Ext.get('finishState').dom.value =
				 rec.get('spjs.finishState')
				 == null ? "" : rec.get('spjs.finishState');
				 Ext.get('finishAppraisal').dom.value =
				 rec.get('spjs.finishAppraisal')
				 == null ? "" : rec.get('spjs.finishAppraisal');
				 // Ext.get('spjs.appraisalBy').dom.value = rec.get
