...
Ext.onReady(function() {
	...
	function getApproveAction() {
		// if (opticketStatus ==
		// "<%=BussiStatusEnum.REPORT_STATUS.getValue()%>") {
		// return "opticket/watcherSign.action";
		// } else if (opticketStatus ==
		// "<%=BussiStatusEnum.WARCH_APPROVE_STATUS.getValue()%>") {
		// return "opticket/chargerSign.action";
		// } else if (opticketStatus ==
		// "<%=BussiStatusEnum.CHARG_APPROVE_STATUS.getValue()%>") {
		// return "opticket/dutySign.action";
		// } else if (opticketStatus ==
		// "<%=BussiStatusEnum.CLASS_LEAD_APPROVE_STATUS.getValue()%>") {
		// return "opticket/endSign.action"
		// }
		if (opticketStatus == OpStatus.readyReport) {
			return "opticket/headSign.action";
		} else if (opticketStatus == OpStatus.safeDeptReady) {
			return "opticket/engineerSign.action";
		} else if (opticketStatus == OpStatus.headReady) {
			return "opticket/safeDeptSign.action";
		}
	}
	// 设置响应时间
							...
							success : function(action) {
								...
								if (result) {
									...
									params.push("&eventIdentify="
											+ eventIdentify);
									params.push("&appointNextRoleOrNextPeople="
											+ nrs);

									Ext.lib.Ajax.request('POST',
											getApproveAction(opticketStatus), {
												success : function(action) {
													var result = eval("("
															+ action.responseText
															+ ")");
