...
//		if (opticketStatus == "<%=BussiStatusEnum.REPORT_STATUS.getValue()%>") {
//			return "opticket/watcherSign.action";
//		} else if (opticketStatus == "<%=BussiStatusEnum.WARCH_APPROVE_STATUS.getValue()%>") {
//			return "opticket/chargerSign.action";
//		} else if (opticketStatus == "<%=BussiStatusEnum.CHARG_APPROVE_STATUS.getValue()%>") {
//			return "opticket/dutySign.action";
//		} else if (opticketStatus == "<%=BussiStatusEnum.CLASS_LEAD_APPROVE_STATUS.getValue()%>") {
							...
							success : function(action) {
								...
								if (result) {
									...
									params.push("&appointNextRoleOrNextPeople="
											+ nrs);
									Ext.lib.Ajax.request('POST',
											getApproveAction(opticketStatus,isSingle), {
												success : function(action) {
													var result = eval("("
															+ action.responseText
															+ ")");
