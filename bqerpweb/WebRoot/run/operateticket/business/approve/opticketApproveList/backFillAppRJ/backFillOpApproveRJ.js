...
Ext.onReady(function() {
	...
	var printOP = new Ext.Button({
		...
		handler : function() {
			...
			viewOperateTicketRJBirt(opticketCode);
			isSeePrint = true;
		}
	})
	var printDG = new Ext.Button({
		id : 'printDG',
		text : "危险点打印",
		iconCls:'print',
		handler : function() {
			viewOperateTicketDangerBirt(opticketCode);
			isDangerPrint = true;
		}
	})
	...
	var form = new Ext.FormPanel({
		...
		items : [tbar, titleField, tableField,
				showAppointNextRoles, approveSet, planDate, remarkSet]
	});
