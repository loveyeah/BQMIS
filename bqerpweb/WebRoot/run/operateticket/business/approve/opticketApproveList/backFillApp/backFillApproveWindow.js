...
Ext.onReady(function() {
	...
	var panel1 = new Ext.FormPanel({
		...
		items : [{
			html : '<iframe src="run/operateticket/business/approve/opticketApproveList/backFillApp/backFillOpApprove.jsp" name="app" style="width:100%;height:480;border:0px;""></iframe>'
		}]
	});
	...
	var panel4 = new Ext.FormPanel({
		...
		title : '操作前检查项目信息',
		items : [{
			html : '<iframe src="run/operateticket/business/approve/opticketApproveList/backFillApp/backFillStepInfo.jsp"  style="width:100%;height:480;border:0px;""></iframe>'
		}]
	});
	var panel5 = new Ext.FormPanel({
		...
		title : '操作后完成工作信息',
		items : [{
			html : '<iframe src="run/operateticket/business/approve/opticketApproveList/backFillApp/backFillWorkInfo.jsp"  style="width:100%;height:480;border:0px;""></iframe>'
		}]
	});
