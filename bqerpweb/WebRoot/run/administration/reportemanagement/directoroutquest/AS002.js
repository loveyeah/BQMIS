...
Ext.onReady(function() {
	...
	var proxyQuest = new Ext.data.HttpProxy({
				url : 'administration/getDirectorOutQuest.action'
			});
	...
	var proxyApplyId = new Ext.data.HttpProxy({
				url : 'administration/getDirectorOutNewApplyId.action'
			});
...
//							}
						...
						formpanelDetail.getForm().submit({
							...
							method : Constants.POST,
							url : 'administration/saveDirectorOutQuost.action',
