	...
	Ext.Ajax.request({
		...
		success : function(result, request) {
			...
			if (responseArray.success == true) {
				...
				// items : [westGrid]
				// });
				var _url2 = "run/runlog/business/runshiftrecord/shiftrecord.jsp?runlogId="
						+ runlogid;
				...
				var _url5 = "run/runlog/maint/shiftparm/runshiftparm.jsp?runlogId="
						+ runlogid;
				var _url6 = "run/runlog/business/runshiftrecord/notcompletion.jsp?runlogId="
						+ runlogid;
				var _url7="productiontec/dependabilityAnalysis/blockDependInput/blockDependInput.jsp";
				var _url8="productiontec/dependabilityAnalysis/assistRecordRegister/assistRecordRegister.jsp";
