...
Ext.onReady(function() {
    ...
    var tabPanel = new Ext.TabPanel({
        ...
        items : [{
            id : 'tabBaseInfo',
            title : '标准票明细',
            html : "<iframe name='tabBaseInfo' src='run/bqworkticket/business/standardTicketRegister/baseInfo/workticketBaseInfo.jsp' style='width:100%;height:100%;border:0px;'></iframe>"
        }, 
//        	{
//            id : 'tabContent',
//            title : '标准票内容'
//        },
        {
            ...
            id : 'tabReport',
            title : '标准票上报列表',
            html : "<iframe name='tabReport' src='run/bqworkticket/business/standardTicketRegister/report/workticketReport.jsp' style='width:100%;height:100%;border:0px;'></iframe>"
        }]
    });
...
//            }
         ...
         //       var tab2 = tabPanel.getItem('tabContent');
                ...
                // 工作票内容链接地址
//                var tab2Href = 'run/bqworkticket/business/standardTicketRegister/content/workticketContent.jsp';
