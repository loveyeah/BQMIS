...
Ext.onReady(function() {
 ...
 var printDangerButton  = new Ext.Button({
    ...
    var titleField = new Ext.Panel({
        ...
        height : 80,
        items : [label],
        buttons : [btnPrintWorkticket,printDangerButton],
				defaults : {
					buttonAlign : 'right'
				}
    })
    ...
    //----------------------
       var pemitStartDate = new Ext.form.TextField({
        id : 'pemitStartDate',
        fieldLabel : "允许动火时间",
        name : 'pemitStartDate',
        style : 'cursor:pointer',
    	...
    	var pemitStartDatePanel = new Ext.Panel({
        height : 40,
        border : false,
        style : "padding-top:10;border-width:1px 0 0 0;",
         layout : "column",
...
//         }
		...
		items : [noticeField,titleField, pemitStartDatePanel,tableField, showAppointNextRoles, approveSet,
				remarkSet]
	});
    ...
    var validateWin = new Ext.Window({
        ...
        buttons : [{
            ...
            handler : function() {
             ...
             //----------审批------------------------
            form.getForm().submit({
			url : 'bqworkticket/pemitStartApprove.action',
			waitMsg : '正在保存数据...',
			method : 'post',
			params : {
				workticketNo : strBusiNo,
				...
				permitStartDate:pemitStartDate.getValue()
			},
