...
Ext.onReady(function() {
    ...
    var tabPanel = new Ext.TabPanel({
        ...
        items : [ {
            id : 'tabReport',
            title : '工作票列表',
            html : "<iframe name='tabReport' src='run/bqworkticket/business/register/report/workticketQueryForUpdate.jsp' style='width:100%;height:100%;border:0px;'></iframe>"
        },{
            id : 'tabBaseInfo',
            title : '工作票明细'
           // html : "<iframe name='tabBaseInfo' src='run/bqworkticket/business/register/baseInfo/workticketBaseInfoForUpdate.jsp' style='width:100%;height:100%;border:0px;'></iframe>"
        },
//        {
//            id : 'tabContent',
//            title : '工作票内容'
            ...
            Register.prototype._checkWorkticketNo = function() {
            	//工作票基本信息
            	  var tab1 = tabPanel.getItem('tabBaseInfo');
            	     var tab1Href = 'run/bqworkticket/business/register/baseInfo/workticketBaseInfoForUpdate.jsp';
                     var tab1Html = "<iframe name='tabBaseInfo' src='" + tab1Href + "'style='width:100%;height:100%;border:0px;'></iframe>";;
                // 工作票内容
...
//                var tab2Html = "<iframe name='tabContent' src='" + tab2Href + "'style='width:100%;height:100%;border:0px;'></iframe>";;
                // 工作票安措链接地址
                var tab3Href = 'run/bqworkticket/business/register/safety/workticketSafetyForUpdate.jsp';
                var tab3Html = "<iframe name='tabSafety' src='" + tab3Href + "'style='width:100%;height:100%;border:0px;'></iframe>";;
                
                var tab5=tabPanel.getItem('tabApprove');
                 var tab5Href='run/bqworkticket/business/register/workticketApproveUpdate.jsp';
                var tab5Html="<iframe name='tabApprove' src='" + tab5Href + "'style='width:100%;height:100%;border:0px;'></iframe>";
                ...
                if (this.workticketNo) {
                	 ...
                	 if (tab1.rendered) {
                        ...
                        // 设置工作票基本信息页面可用
                        tabPanel.getItem('tabBaseInfo').un('beforerender', this.blockShow);
                    }
...
//                    }
                    ...
                    if (tab3.rendered) {
                     ...
                     if (tab4.rendered) {
                      ...
                      if (tab5.rendered) {
                        Ext.getCmp('tabPanel').remove(tab5);
                        Ext.getCmp('tabPanel').insert(4, {
                            id : tab5.id,
                            title: tab5.title,
                            html: tab5Html
                        });
                        ...
                        // 设置工作票审批信息页面可用
                         tabPanel.getItem('tabApprove').un('beforerender', this.blockShow);
                    }
                } else {
                    // 没有设置工作票编号
                     if (tab1.rendered) {
             ...
             //       tabPanel.getItem('tabContent').on('beforerender', this.blockShow);
                    ...
                    tabPanel.getItem('tabDanger').on('beforerender', this.blockShow);
                     ...
                     tabPanel.getItem('tabBaseInfo').on('beforerender', register.blockShow);
                      tabPanel.getItem('tabApprove').on('beforerender', register.blockShow);
                }
            }
