...
<html>
	...
	<body  bgcolor="#EDEDED">
		...
		<table width="80%" height="93%" border="0">
			<tr height="100%">
				<td width="45%">
					<div id="already-role-div" style="width:100%;height:100%"></div>
				</td>
				<td width="10%" id="button-role-div">
		...
		<script type="text/javascript" src="run/bqworkticket/maint/threeKindPerson/resperson.js"></script>
	</body>
</html>
