...
Ext.onReady(function() {
	...
	var protectionType = arg.protectionType;
	var blockId = arg.blockId;
	var nextRolePs = arg.nextRolePs;
	...
	var lblApprove = new Ext.form.Label({
		id : 'lblApprove',
		text : '相关领导审批',
		style : "color:blue;font-size:30px;line-height:100px;padding-left:100px;font-weight:bold"
	});
	...
	function getCurrentSteps() {
		...
		if ((protectionType == '1')&&(blockId == '1')||(protectionType == '2')&&(blockId == '1')) {
			flag4 = true;
		}
		if ((protectionType == '3')&&(blockId == '1')||(protectionType == '4')&&(blockId == '1')) {
			flag5 = true;
		}
		if ((protectionType == '1')&&(blockId == '4')||(protectionType == '2')&&(blockId == '4')) {
			flag6 = true;
		}
		if ((protectionType == '3')&&(blockId == '4')||(protectionType == '4')&&(blockId == '4')) {
			flag7 = true;
		}
		Ext.Ajax.request({
					...
					params : {
						...
						jsonArgs : "{'DQZZSP':" + flag1 + ",'RKZZSP':" + flag2 + ",'ZZECFH':" + flag3 + ",'300DQGGJZZ':" 
						+ flag4 +",'300RKGGCKBBZ':" + flag5 + ",'125DQGGYXBZ':" + flag6 + ",'125RKGGCKBBZ':" + flag7 + "}"
					},
					success : function(result, request) {
				...
				Ext.lib.Ajax.request('POST',
						'managecontract/contractApproveCheckUser.action', {
							success : function(action) {
								...
								if (result) {
									Ext.Ajax.request({
										url : 'productionrec/approveCastBackProtect.action',
										waitMsg : '正在保存数据...',
										method : 'post',
										params : {
											entryId : entryId,
