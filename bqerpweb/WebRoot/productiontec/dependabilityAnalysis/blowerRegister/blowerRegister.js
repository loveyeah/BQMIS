...
//	alert(type)
     ...
     //   tabPosition : 'bottom',
        ...
        items : [{
            ...
            id : 'tab3',
            title : '送风机技术参数',
            html :"<iframe name='iframe3' id='iframe3' src='productiontec/dependabilityAnalysis/blowerRegister/blowerParam/blowerParam.jsp'style='width:100%;height:100%;border:0px;'></iframe>"
        }]
    });
