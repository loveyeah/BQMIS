...
Ext.onReady(function() {
     ...
     //   tabPosition : 'bottom',
        ...
        items : [{
            ...
            id : 'tab3',
            title : '磨煤机技术参数',
            html :"<iframe name='iframe3' id='iframe3' src='productiontec/dependabilityAnalysis/auxiliaryRegister/fuelParam/fuelParam.jsp'style='width:100%;height:100%;border:0px;'></iframe>"
        }]
    });
