...
Ext.onReady(function() {
     ...
     //   tabPosition : 'bottom',
        ...
        items : [{
            ...
            id : 'tab3',
            title : '电除尘技术参数',
            html :"<iframe name='iframe3' id='iframe3' src='productiontec/dependabilityAnalysis/precipitationRegister/precipitationParam/precipitationParam.jsp'style='width:100%;height:100%;border:0px;'></iframe>"
        }]
    });
