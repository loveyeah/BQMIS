...
Ext.onReady(function() {
	...
	var conModifyId1=getParameter("conModifyId");;
	var conModifyId="";
//	var _url1 = "manage/projectFact/business/conBaseInfo/conBaseInfo.jsp?id="+conId;
	var _url3= "manage/projectFact/business/conBaseInfo/conModifyInfo.jsp?id="+conModifyId1+"&conId="+conId;
	var _url2 = "";
	Ext.Ajax.request({
	...
	var tabpanel = new Ext.TabPanel({
		...
		items : [{
			id : 'tab1',
			title : '合同变更信息1',
			html : '<iframe id="iframe1"  src="' + _url3
