...
Ext.onReady(function() {
	...
	function getNextSteps() {
		...
		} else if (actionId == 73 || actionId == 57) {
...
//			printContractPanel.setVisible(true);
				...
				Ext.lib.Ajax.request('POST',
						'managecontract/contractApproveCheckUser.action', {
							success : function(action) {
								...
								if (result) {
									Ext.Ajax.request({
										url : 'managecontract/proConDelegationApprove.action',
										waitMsg : '正在保存数据...',
										method : 'post',
										params : {
											entryId : entryId,
	...
	var tab2Href = "manage/projectFact/business/contractDelegation/approve/conInfo/conInfo.jsp?id="
			+ conid;
	var tab2Html = "<iframe name='tabDanger' src='" + tab2Href
			+ "'style='width:100%;height:100%;border:0px;'></iframe>";

	var tab3Href = "manage/projectFact/business/contractDelegation/approve/meetSign/proxy.jsp?id="
			+ conid;
