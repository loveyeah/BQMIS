...
Ext.onReady(function() {
	...
	var showWord = getTabTitle(prjStatus);
	...
	function getNextSteps() {
		...
		// if(actionId == "1920"){
		// url =
		// "/power/workflow/manager/apponitNextPerson/apponitNextPerson.jsp";
		// } else{
		...
		if (typeof(ro) != "undefined") {
			if (ro) {
				...
				showAppointNextRoles
						.setText("<span style=\"cursor:hand;color:blue\"  onclick=\"removeAppointNextRoles();\">[取消指定]</span>  您指定下一步审批领导为：[ "
								+ ro.nrsname + " ]");
			}
		}
	};
...
//						}
	...
	function selectRole() {// modify by wpzhu 20100607
		form.getForm().submit({
					url :  'managecontract/prjContractReport.action',
					waitMsg : '正在保存数据...',
					method : 'post',
					params : {
						conid : conId,
