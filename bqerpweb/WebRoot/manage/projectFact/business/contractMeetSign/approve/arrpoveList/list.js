	...
	var btnSign = new Ext.Toolbar.Button({
		...
		handler : function() {
			...
			if (sels.length > 0) {
				...
				var jhflg = record.data.jhFlg;
				parent.Ext.getCmp("maintab").setActiveTab(1);
				var url = "manage/projectFact/business/contractMeetSign/approve/conInfo/conInfo.jsp";
				parent.document.all.iframe2.src = url + "?id=" + id+"&jhflg="+jhflg;
			} else {
