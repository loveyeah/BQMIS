...
Ext.onReady(function() {
	...
	var btnQuery = new Ext.Button({
		...
		minWidth : 70,
		handler : function() {
			var _thisTitle = '<center><font color="blue" size="3">大唐灞桥电厂项目合同付款计划统计</font><br/><br/>'
	...
	function myExport() {
		Ext.Ajax.request({
			...
			success : function(response) {
				...
				var html = ['<table border=1><tr><th>合同编号</th><th>合同名称</th><th>合作伙伴</th><th>有无总金额</th><th>总金额</th><th>币别</th><th>计划付款时间</th><th>计划付款金额</th><th>经办人</th><th>备注</th></tr>'];
...
//				}
	...
	var _title = '<center><font color="blue" size="3">大唐灞桥电厂项目合同付款计划统计</font><br/><br/>'
