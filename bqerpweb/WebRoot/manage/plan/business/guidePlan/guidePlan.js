...
//				anchor : "40%",
		...
		Ext.Ajax.request({
					...
					success : function(result, request) {
										...
										if(signStatus == '1'){
											...
											Ext.MessageBox.alert('提示信息', '该月计划已上报!');
										//if(signStatus == '2'){
										//	Ext.getCmp('btnApprove').setDisabled(true);
										//	}else{
										...
										if(signStatus == '2'){
											...
											Ext.getCmp('btnSave').setDisabled(true);
											Ext.getCmp('btnUpcommit').setDisabled(true);
											Ext.MessageBox.alert('提示信息', '该月计划已审批!');
											}
										}else {
	...
	// 上报
	function upcommit() {
		var url = "../SignGuidePlan/commitGuidePlan.jsp";
		var args = new Object();
	...
	/* 创建表格 */
	//var _title = '<center><font color="blue" size="3">灞桥电厂生产任务指导性计划</font><br/><br/></center>';
