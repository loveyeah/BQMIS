...
Ext.onReady(function() {
	...
	var planTime = arg.planTime;// add by ywliu 20100610
	var flowCode = arg.flowCode;
    var mytitle="部门培训计划回填汇总上报";
    var actionId="";
    var eventIdentify="";
    var workerCode="";
				...
				Ext.lib.Ajax.request('POST',
						'comm/workticketApproveCheckUser.action', {
							success : function(action) {
								...
								if (result) {
									form.getForm().submit({
										url : 'manageplan/TrainPlanBackGatherReport.action',
										waitMsg : '正在保存数据...',
										method : 'post',
										params : {
											approveId : approveId,
											...
											flowCode : flowCode,
											planTime : planTime // add by ywliu 20100610
										},
