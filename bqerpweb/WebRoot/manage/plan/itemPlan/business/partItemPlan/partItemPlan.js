...
Ext.onReady(function(){
	...
	//add by liuyi 20100607  调用最近数据
	var insertDataBtu = new Ext.Button({
		id : 'insetDataBtu',
		text : '调用最近数据',
		iconCls : 'query',
		handler : function() {
	...
	var tbar = new Ext.Toolbar({
		id : 'tbar',
		items : ['计划时间：',planTime,'计划主题：',readText,queryBtu,'-',insertDataBtu,'-',saveBtu,'-',reportBtu,'-',approveBtu]
	})
	// 数据对象
