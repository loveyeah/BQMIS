...
Ext.onReady(function() {
    ...
    var label = new Ext.form.Label({
        id : "label",
        text : "相关领导审批",
         style : "color:blue;font-size:25px;line-height:50px;padding-left:220px;font-weight:bold"
    }); 
    ...
    var graphButton = new Ext.Button({
        ...
        handler : function(){  
        	...
        	{
			 url = "../../../../workflow/manager/flowshow/flowshow.jsp?flowCode="+flowCode;
        	}
        	else
        	{
        		url = "../../../../workflow/manager/show/show.jsp?entryId="+entryId;
        	}
        	window.open(url);
		}
    });
    ...
    var approveHistoryButton = new Ext.Button({
        text : "查看审批记录",
        handler : function() {
			var url = "../../../../workflow/manager/approveInfo/approveInfo.jsp?entryId="
					+ entryId;
	...
	var showAppointNextRoles = new Ext.form.Label({
		...
		if(entryId==null||entryId=="")
		{
			url = "../../../../workflow/manager/appointNextRole/appointNextRoleForReport.jsp";
		}
		else
		{
		 url = "../../../../workflow/manager/appointNextRole/appointNextRole.jsp";
		}
    ...
    var validateWin = new Ext.Window({
        ...
        buttons : [{
            ...
            handler : function() {
             ...
             //----------审批------------------------
            form.getForm().submit({
			url : 'managebudget/budgetMakeCommSign.action',
			waitMsg : '正在保存数据...',
			method : 'post',
			params : {
				budgetMakeId : strBusiNo,
...
　　 // ↑↑****************员工验证窗口****************
 ...
 //---------------------------------------------------------------------------------------------------------------- 
     var tab2Href="manage/budget/business/budgetMakeApprove/makeItemUpdate.jsp?budgetMakeId="+strBusiNo;
