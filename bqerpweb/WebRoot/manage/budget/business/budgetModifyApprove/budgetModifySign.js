...
Ext.onReady(function() {
	...
	var graphButton = new Ext.Button({
		...
		handler : function() {
			...
			if (entryId == null || entryId == "") {
				url = "../../../../workflow/manager/flowshow/flowshow.jsp?flowCode="
						+ flowCode;
			} else {
				url = "../../../../workflow/manager/show/show.jsp?entryId="
						+ entryId;
			}
			window.open(url);
		}
						...
						'comm/workticketApproveCheckUser.action', {
							success : function(action) {
								...
								if (result) {
									//----------审批------------------------
									form.getForm().submit({
										url : 'managebudget/budgetModifyApproveSign.action',
										waitMsg : '正在保存数据...',
										method : 'post',
										params : {
											changeId : strBusiNo,
	...
	//---------------------------------------------------------------------------------------------------------------- 
//	var tab2Href = "manage/budget/business/budgetMakeApprove/makeItemUpdate.jsp?budgetMakeId="
//			+ strBusiNo;
