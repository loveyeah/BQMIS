...
Ext.onReady(function() {
	...
	var strBusiNo = arg.budgetGatherId;

	var entryId = arg.entryId;
	var flowCode = arg.workflowType;
	var mytitle = "部门预算汇总上报";
	var actionId = "";
	var eventIdentify = "";
	var workerCode = "";
						...
						'comm/workticketApproveCheckUser.action', {
							success : function(action) {
								...
								if (result) {
									...
									params.push("budgetGatherId=" + strBusiNo);
									// 备注
									params
											.push("&approveText="
													+ form.getForm()
									...
									Ext.lib.Ajax
											.request(
													'POST',
													'managebudget/budgetGatherReportTo.action',
													{
														success : function(
																action) {
															var result = eval("("
