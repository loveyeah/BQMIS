...
//							
//							obj = {
//						budgetGatherId : e.record.get("budgetGatherId"),
//						topicId : e.record.get("topicId"),
//						budgetTime : e.record.get("budgetTime"),
//						gatherBy : fillBy.getValue(),
//						gatherWorkFlowNo : e.record.get("gatherWorkFlowNo"),
//						gatherStatus : e.record.get("gatherStatus"),
//						centerId : e.field,
//						itemId : e.record.get("itemId"),
//						adviceBudget : e.record.get(e.field),
//						dataSource : null,
//						budgetMakeId : e.record.get("budgetMakeId")
//					};
//					mod.push(obj);
//					
					//alert(Ext.util.JSON.encode(mod));
					...
					var v1 = new Object();
						...
						m.put(e.field + " " + e.record.get("itemId"), v1);
							//alert(Ext.util.JSON.encode(m.values()));
						});
				  //----------------------------------------------------		
				Ext.Msg.hide();
			},
...
//				for(var j = 2; j <= grid.getColumnModel().getColumnCount() - 2; j++)
//				{
//					var budgetGather = ds.getAt(i).get('budgetGatherId');
//					var topic = ds.getAt(i).get('topicId');
//					var time = ds.getAt(i).get('budgetTime');
//					var gatherFill = fillBy.getValue();
//					var gatherWorkFlow = ds.getAt(i).get('gatherWorkFlowNo');
//					var status = ds.getAt(i).get('gatherStatus');
//					var center = grid.getColumnModel().getDataIndex(j);
//					var item = ds.getAt(i).get('itemId');
//					var hearder = grid.getColumnModel().getDataIndex(j)
//					var advice = grid.getStore().getAt(i).get(hearder)
//					var budgetMake = ds.getAt(i).get('budgetMakeId');
//
//					obj = {
//						budgetGatherId : budgetGather,
//						topicId : topic,
//						budgetTime : time,
//						gatherBy : gatherFill,
//						gatherWorkFlowNo : gatherWorkFlow,
//						gatherStatus : status,
//						centerId : center,
//						itemId : item,
//						adviceBudget : advice,
//						dataSource : null,
//						budgetMakeId : budgetMake
//					};
//					mod.push(obj);
//					alert( Ext.util.JSON.encode(mod));
//					return;
