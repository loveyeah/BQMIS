...
<body>
	<script type="text/javascript" src="manage/contract/business/contractMeetSign/register/contBase/base.js"></script>
	<div id="div_lay" width="100%"></div>
	<div id="win" width="100%"></div>
</body>
</html>