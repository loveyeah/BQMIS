...
Ext.onReady(function() {
	...
	var _url1 = "manage/contract/business/contractBalance/approve/balanceInfo/balanceInfo.jsp";
	if(conId!="")
		_url1 +="?conId="+conId;	
	var _url2 = "manage/contract/business/contractBalance/approve/balanceInfo/balInvoice.jsp";
	var _url3 = "manage/contract/business/contractBalance/approve/balanceInfo/materialList.jsp";
	if(contractNo != "")
		_url3 +="?contractNo="+contractNo;
	if(balanceId!=""){
