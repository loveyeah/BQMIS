...
Ext.onReady(function() {
	...
	function CheckRptPreview() {
		...
		if (selrows.length > 0) {
			...
			// } else {
			var id = selrows[0].data.conModifyId;
	...
	function updateRecord() {
		if (grid.selModel.hasSelection()) {
			...
			if (recordslen > 1) {
				...
				url2 = "manage/contract/business/modifyMeetSign/register/tabPayPlan/payplan.jsp";
				...
				// var execFlag = record.get("execFlag");
				...
				var url1 = "manage/contract/business/modifyMeetSign/register/tabBase/base.jsp";
