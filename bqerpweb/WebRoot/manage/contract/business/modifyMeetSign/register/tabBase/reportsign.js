...
//					var _radio = new Ext.form.Radio({
//								boxLabel : "<font size='2.6px'>"
//										+ radio[1].actionName + "</font>",
//								id : 'approve-radio' + radio[1].actionId,
//								name : 'rb-approve',
//								inputValue : radio[1].actionId,
//								url : radio[1].url,
//								eventIdentify : radio[1].changeBusiStateTo,
//								checked : true,
//								listeners : {
//									'check' : function() {
//										var _actionId = Ext.ComponentMgr
...
//									// 设定默认工号
//									workCode.setValue(action.responseText);
//								}
//							}
//						});
