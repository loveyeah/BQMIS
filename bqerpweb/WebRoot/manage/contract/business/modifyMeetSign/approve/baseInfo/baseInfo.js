	...
	if (id != null && id != "") {
		Ext.Ajax.request({
					...
					success : function(result, request) {
						...
						deptFlg = o.data.deptFlg;
						
						oriFileName.setValue((o.data.filePath == null)
								? ""
								: o.data.filePath);
	...
	var formtbar = new Ext.Toolbar({
		items : [{
			...
			handler : function() {
				...
				var url;
				if (deptFlg == "W") {
						url = "../../../../../../manage/contract/business/modifyMeetSign/approve/meetSign/JHsign.jsp?entryId="
							+ entryId + "&id=" + id + "&sum=" + sum;
				} else {
					url = "../../../../../../manage/contract/business/modifyMeetSign/approve/meetSign/sign.jsp?entryId="
							+ entryId + "&id=" + id + "&sum=" + sum;
				}
				...
				if (o) {
					...
					var url = "manage/contract/business/modifyMeetSign/approve/arrpoveList/list.jsp";
