...
<html>
	...
	<body>
		<script type="text/javascript" src="manage/project/bussiness/prjNewApply/PrjJApplyApproval.js" defer="defer"></script>
		<script type="text/javascript" src="manage/project/bussiness/prjNewApply/PrjJApplyApprovalMain.js" defer="defer"></script>
	<div id="div_lay" style="width:100%">
	</body>
</html>