...
//	var showWord = getTabTitle(prjStatus);
	...
	var label = new Ext.form.Label({
		id : "label",
		// text : showWord,
		style : "color:blue;font-size:30px;line-height:100px;padding-left:200px;font-weight:bold"
	});
...
//	signPanel.setTitle(showWord);
				...
				Ext.lib.Ajax.request('POST',
						'comm/workticketApproveCheckUser.action', {
							success : function(action) {
								...
								if (result) {
									form.getForm().submit({
										url : 'manageproject/approveProject.action',
										waitMsg : '正在保存数据...',
										method : 'post',
										params : {
											prjNo : prjNo,
	...
	var infoPanel = new Ext.Panel({
		title : "详细信息",
		html : "<iframe name='tabContent' src='manage/project/bussiness/signProject/lookProject.jsp' style='width:100%;height:100%;border:0px;'></iframe>"
	});
