...
Ext.onReady(function() {
				...
				Ext.lib.Ajax.request('POST',
						'comm/workticketApproveCheckUser.action', {
							success : function(action) {
								...
								if (result) {
									form.getForm().submit({
										url : 'manageproject/reportProject.action',
										waitMsg : '正在保存数据...',
										method : 'post',
										params : {
											prjNo : prjNo,
    ...
    var check_url = "";
    if(check == "check"){
    check_url = 'manage/project/bussiness/signProject/lookProjectcheck.jsp';
    } else {
    check_url = 'manage/project/bussiness/signProject/lookProject.jsp';
    }
	// 票面浏览panel
	var infoPanel = new Ext.Panel({
		title : "详细信息",
		html : "<iframe name='tabContent' src='"+check_url+"'  style='width:100%;height:100%;border:0px;'></iframe>"
	});
