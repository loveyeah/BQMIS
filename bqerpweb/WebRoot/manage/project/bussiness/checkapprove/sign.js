...
Ext.onReady(function() {
	...
	function getCurrentSteps() {
		...
		//var xx="{'sumBelow1w':"+sumBelow1w+",'sumBelow5w':"+sumBelow5w+",'is12Failure':true,'isYSZC':true}";
		Ext.Ajax.request({
			...
			params : {
				...
				jsonArgs : "{'sumBelow1w':"+sumBelow1w+",'sumBelow5w':"+sumBelow5w+",'is12Failure':true,'isYSZC':true}"
			},
			success : function(result, request) {
