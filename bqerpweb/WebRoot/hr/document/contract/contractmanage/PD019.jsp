...
<title>终止合同登记</title>
    ...
    <script type="text/javascript" src="hr/document/contract/contractmanage/PD019.js"></script>
    <script type="text/javascript" src="hr/common/AppendFilePanel.js"></script>
    <script type="text/javascript" src="comm/scripts/MessageConstants.js"></script>
	<style>
	.x-form-field-wrap .noButtonCombobox{width:0px;height:0px;}
	</style>
</head>
<body>
