...
Ext.onReady(function() {
    ...
    var empStore = new Ext.data.JsonStore({
        url : 'ca/getEmpName.action',
        root : 'list',
        totalProperty : 'totalCount',
        fields : ['empId', 'empName', 'deptId', 'deptName']
    })

    // 员工姓名
    var txtEmpName = new Ext.form.ComboBox({
        valueField : 'empId',
        width : 100,
    ...
    empStore.on('load', function(e, records, o) {
        txtDeptName.setValue(records[0].data.deptName);
        hdnDeptId.setValue(records[0].data.deptId);
        leaveInfoStore.load({
            params : {
                start : 0,
                limit : Constants.PAGE_SIZE,
                empId : txtEmpName.getValue(),
    ...
    var headForm = new Ext.form.FieldSet({
        ...
        items : [{
                ...
                items : [{
                        ...
                        border : false,
                        layout : 'form',
                        style : 'paddingTop:5px;font-size:12px;',
    ...
    function checkDate(date1, date2) {
        var start = Date.parseDate(date1, 'Y-m-d');
        var end = Date.parseDate(date2, 'Y-m-d');
