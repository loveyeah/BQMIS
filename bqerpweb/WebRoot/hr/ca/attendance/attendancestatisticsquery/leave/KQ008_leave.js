...
Ext.onReady(function() {
   ...
   // 帐票预览
    ...
    function queryHandler() {
        ...
        document.all.popFrame.src = "/power/report/webfile/hr/ca/KQ013_attendentStatistics.jsp?type=1"+'&year='+year+"&month="+month;
    }
    ...
    function exportHandler() {
		Ext.Msg.confirm(Constants.CONFIRM, Constants.COM_C_007, function(
				buttonobj) {
			if (buttonobj == "yes") {
