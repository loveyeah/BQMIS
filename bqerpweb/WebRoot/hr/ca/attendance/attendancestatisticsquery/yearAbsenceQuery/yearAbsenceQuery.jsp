...
<html>
	...
	<script type="text/javascript" src="comm/ext/ComboBoxTree.js"></script>
		<script type="text/javascript"
			src="hr/ca/attendance/attendancestatisticsquery/yearAbsenceQuery/yearAbsenceQuery.js"></script>
			<Iframe name="popFrame" src=""></IFrame>
			<Iframe name="popFrame1" src="" border="0px"
