...
Ext.onReady(function() {
   ...
   // 帐票预览
    ...
    function queryHandler() {
        ...
        document.all.popFrame.src = "/power/report/webfile/hr/ca/KQ013_attendentStatistics.jsp?type=2"+'&year='+year+"&month="+month;
    }
        ...
        Ext.Msg.confirm(Constants.CONFIRM, Constants.COM_C_007, function(buttonobj) {
            if (buttonobj == "yes") {
				document.all.popFrame1.src = "ca/exportLeaveStatisticsQueryInfo.action?year="
						+ queryObject.year + "&month=" + queryObject.month+"&type=2";
			}
        });
