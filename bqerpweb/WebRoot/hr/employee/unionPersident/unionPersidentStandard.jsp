...
<title>分工会主席标准维护</title>
    <jsp:include page="../../../comm/jsp/commjsp.jsp"></jsp:include>
    <script type="text/javascript"
			src="comm/scripts/hr/hr-common.js"></script>
...
<body>
	<script type="text/javascript" src="hr/employee/unionPersident/unionPersidentStandard.js"></script>
</body>
</html>