...
Ext.onReady(function() {
	...
	var label = new Ext.form.Label({
		id : "label",
		text : showWord,
		style : "color:blue;font-size:30px;line-height:100px;padding-left:30px;font-weight:bold"
	});
				...
				Ext.lib.Ajax.request('POST',
						'comm/workticketApproveCheckUser.action', {
							success : function(action) {
								...
								if (result) {
									form.getForm().submit({
										url : 'hr/reportHrJLaborTempe.action',
										waitMsg : '正在保存数据...',
										method : 'post',
										params : {
											tempeId : tempeId,
