...
Ext.onReady(function() {
	...
	var id = 0;
	var _url1 = "equ/workbill/workbillApproveList/workbillApproveList.jsp";
	var _url2 = "equ/workbill/billMessage/BMessage.jsp?flag=approve";
	var _url3 = "equ/workbill/plannedCost/plannedCost.jsp";
	var _url4 = "equ/workbill/relateworktickets/reworktickets.jsp";
	var _url5 = "equ/workbill/relatemateriel/RMateriel.jsp";
	var _url6 = "equ/workbill/factualCost/factualCost.jsp";
	var _url7 = "equ/workbill/wolog/wolog.jsp";
	var _url8 = "equ/workbill/finishedRpt/finishedRpt.jsp";
	var getWocode = "";
	var workorderStatus;
	var woCode;
	var faWoCode;
	var tabPanel = new Ext.TabPanel({
		...
		items : [{
			...
			title : '执行日志',
			listeners : {
			activate : function() {//modify by drdu 091116
					if (getWocode != " null"
							&& getWocode.length > 1
...
//					 }
	...
	function Register() {
		...
		Register.prototype.getstdPage = function(argNo, argFano, argStatus) {
			getWocode = "?woCode=" + argNo + "&faWoCode=" + argFano
					+ "&workorderStatus=" + argStatus;
			workorderStatus = argStatus;
			woCode = argNo;
