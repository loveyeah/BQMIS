...
Ext.onReady(function() {
	...
	// 专业
	var url = "manageplan/getRepairSpecialityType.action";
...
//		}
	...
	var failureCode = new Ext.form.ComboBox({
		...
		// // Ext.getCmp('failureContent').setValue(no.failureContent)
		// }
		//
		// }
		// },
...
//				}
	...
	var workman = new Ext.form.ComboBox({
		...
		anchor : "100%"
			...
			// document.getElementById("workChargeCode").value = rvo.workerName;
			// }
			// }
		});
				...
				'workbill/findByFaWoCode.action?editWoCode=' + editwoCode, {
					success : function(action) {
						...
						Ext.get("remark").dom.value = (ob.equJWo.remark == null)
								? ""
								: ob.equJWo.remark;
						Ext.get("workChargeCode").dom.value = (ob.workChargeName == null)
								? ""
								: ob.workChargeName;
	...
	disable();
		...
		// 工单保存后调用标准包不可用
		// if (editwoCode != null && editwoCode != "" && editwoCode !=
		// "undefined")
		//
		// Ext.get("btnstdpage").dom.disabled = true;
		//
