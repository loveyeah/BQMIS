					...
					listeners : {
						'check' : function() {
							...
							eventIdentify = obj.eventIdentify;
											...
											if(eventIdentify=='XYDJZSP'){
												remark.setValue("需要点检长审批");
											}else {
												remark.setValue("同意!");
											}
									...
									check : function(radio, checked) {
										if (checked) {
											...
											if(radio.eventIdentify=='TH'){
												remark.setValue("退回!");
											}else if(radio.eventIdentify=='XYDJZSP'){
												remark.setValue("需要点检长审批");
											}else if(radio.eventIdentify=='BXYDJZSP'){
												remark.setValue("不需要点检长审批");
											}else {
												remark.setValue("同意");
											}
				...
				Ext.lib.Ajax.request('POST',
						'managecontract/contractApproveCheckUser.action', {
							success : function(action) {
								...
								if (result) {
									Ext.Ajax.request({
										url : 'workbill/approveWorkBill.action',
										waitMsg : '正在保存数据...',
										method : 'post',
										params : {
											entryId : entryId,
