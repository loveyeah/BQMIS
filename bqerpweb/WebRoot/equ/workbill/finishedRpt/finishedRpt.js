...
Ext.onReady(function() {
	...
	// border : false,
	// style :
	// "padding-top:10;padding-left:10px;padding-bottom:10px;border-width:0 0 0
	// 0;",
	// items : [
	// lblRemarks,
	// remark]
	...
	var validateWin = new Ext.Window({
		...
		buttons : [{
			...
			handler : function() {
				...
				if (id == null)
					url1 = 'workbill/saveEquJFinishedRpt.action';
				else
					url1 = 'workbill/updateEquJFinishedRpt.action';

				// 工号确认
				Ext.lib.Ajax.request('POST',
						'workbill/finishedRptCheckUser.action', {
...
//										waitMsg : '正在保存数据...',
										...
										params : {
											woCode : woCode,
											checkReportid : Ext.get("checkReportid").dom.value,
											checkResultid : Ext
													.get("checkResultid").dom.value,
											checkReasonid : Ext
													.get("checkReasonid").dom.value,

											peNotion : Ext.get("peNotion").dom.value
									...
									Ext.MessageBox.alert('错误', '用户名或密码输入不正确！');
								}
							}
