...
Ext.onReady(function() {
	...
	var cm = new Ext.grid.ColumnModel({
		...
		rows : [[{
			header : "<b><font color='black'; font-weight:bold; size='5'>灞桥电厂缺陷统计报表(按设备)</font></b><br/>",
			height :'50',
			colspan : 6,
			align : "center"
		}]]
	...
	var ds = new Ext.data.Store({
		...
		url : 'bqfailure/failureQueryByEqu.action'
		}),
	...
	function reportexport() {
		Ext.Ajax.request({
			...
			success : function(response) {
				...
				var html = ['<table border=1><tr><td align="center" colspan="6"><b><h1>灞桥电厂缺陷统计报表(按设备)</h1></b></td></tr><tr><th>设备编码</th><th>设备名称</th><th>发现数</th><th>消缺数</th><th>待处理数</th><th>消缺率</th></tr>'];
				for (var i = 0; i < records.length; i += 1) {
					var rc = records[i];
					html.push('<tr><td>' + rc.attributeCode + '</td><td>'
							+ rc.equName + '</td><td>' + rc.count
