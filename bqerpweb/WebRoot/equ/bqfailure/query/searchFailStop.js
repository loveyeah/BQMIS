...
Ext.onReady(function() {
	...
	var repairDepturl = "bqfailure/queryRepairDeptStopList.action";
	...
	var ds = new Ext.data.GroupingStore({
				proxy : new Ext.data.HttpProxy({
							url : 'bqfailure/queryListByStatus.action?stop=stop',
							method : 'post'
						}),
	...
	var tbar2 = new Ext.Toolbar({
				...
				items : ['状态：', allRadio, confirmRadio, elRadio,
						arbitrateRadio, awaitRadio, awaitEndRadio, checkRadio,
						endRadio, invalidRadio, stopRadio]
			});
