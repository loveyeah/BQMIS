Ext.namespace('Power.workFlowSign'); 

//	var obj=new Object();
//	obj.busiNo="1234";
//	obj.entryId=208705;
//	obj.flowCode="hfResourcePlanSC";
//	obj.title="测试上报审批";
//	
//		 var sign=new Power.workFlowSign(obj);
//		  sign.win.show();
Power.workFlowSign=function(obj,approveAction)
{
...
//    var arg = window.dialogArguments
    ...
    var strBusiNo =obj.busiNo;
    
    var entryId =obj.entryId;//208705;// null;//
    var flowCode=obj.flowCode;// "hfResourcePlanSC";//arg.flowCode;
    ...
    var tableField = new Ext.Panel({
        ...
        items : [
				...
				// 查看审批记录按钮
				{
					...
					border : false,
					id:'approve_his',
					hidden:entryId==null?true:false,
                ...
                Ext.lib.Ajax.request('POST', 'comm/workticketApproveCheckUser.action',
                    {success : function(action) {
                        ...
                        if (result) {
                            ...
                            params.push("busiNo=" + strBusiNo);
                            // 备注
                            params.push("&approveText=" + form.getForm().getValues()['remark'] + "");
                            // 工号
                            params.push("&workerCode=" + workCode.getValue());
                            // 审批方式
                            params.push("&actionId=" +actionId); //form.getForm().getValues()['rb-approve']);
                            // 响应时间
                            params.push("&responseDate=" + datePicker.getValue());
