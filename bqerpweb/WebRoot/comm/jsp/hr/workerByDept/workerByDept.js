...
Ext.onReady(function() {
	...
	var selectModel = arg.selectModel ;
	// 默认为单选
	var isSingleSelect = !(selectModel == "multiple");
	var notIn = arg ? arg.notIn : "";
	var flag = arg ? arg.flag : "";//add by sychen 20100818
	//add by kzhang 20100901
	//是否班组过滤 不等于null或""时，不进行班组过滤
	var isbanzuuse="";
	if (arg.isbanzuuse!=null) {
		isbanzuuse=arg.isbanzuuse
	}
	//-----------------
	...
	var deptIdChoose = new Ext.ux.ComboBoxTree({
				...
				tree : {
					...
					loader : new Ext.tree.TreeLoader({
								dataUrl : 'comm/getDeptsByPid.action?flag='+isbanzuuse// 'empInfoManage.action?method=getDep'
							}),
	...
	ds.on('beforeload', function() {
		Ext.apply(this.baseParams, {
			...
			,flag:flag//add by sychen 20100818
		});
	});
	ds.load({
				params : {
