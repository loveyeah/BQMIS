...
public class TimeKeeperExamineAction extends AbstractAction {
    /**
     * 查询条件类
     * 
     * @author huangweijie
    ...
    private String node;
    /** 定义ejb接口 */
    private TimeKeeperExamineFacadeRemote remote;
    /** 开始日期 */
     ...
     * @throws IOException
     */
    public TimeKeeperExamineAction() throws IOException {
        remote = (TimeKeeperExamineFacadeRemote) factory.getFacadeRemote("TimeKeeperExamineFacade");
        // 加载配置文件
    ...
    public void getAttendanceList() {
        try {
            ...
            // 查询考勤记录列表
            obj = remote.getExamineInfo(examineDate, examineDept, employee.getEnterpriseCode(), p);
            // 设置查询条件
    ...
    public void exportAttendanceQueryFile() throws Exception {
        try {
            ...
            bossForm = remote.getExamineInfo(qObj.getExamineDate(), qObj.getExamineDept(), qObj.getEnterpriseCode(), p);
