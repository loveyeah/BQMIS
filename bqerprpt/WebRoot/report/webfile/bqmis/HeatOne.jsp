...
<body>
<!--  
<birt:viewer id="heat1"
	 top="0"
	 left="0"
	 width="900"
	 height="800"
	 reportDesign="HeatOne.rptdesign"
	 showTitle="false"
	 showToolBar = "false"
	 pageOverflow="1"
	 frameborder="no"
...
%><birt:report id="HeatOne" reportDesign="bqmis/HeatOne.rptdesign" position="absolute"
...
document.getElementsByName('HeatOne')[0].align='center';
</script>
	</body>
