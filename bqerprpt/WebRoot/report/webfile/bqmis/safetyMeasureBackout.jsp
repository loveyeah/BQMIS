...
-->
<div >
<birt:report id="safetyMeasureBackout" reportDesign="bqmis/safetyMeasureBackout.rptdesign" position="absolute"
...
document.getElementsByName('safetyMeasureBackout')[0].align='center';
</script>
