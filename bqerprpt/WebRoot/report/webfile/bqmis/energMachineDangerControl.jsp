...
<birt:report id="energMachineDangerControl" reportDesign="bqmis/energMachineDangerControl.rptdesign" position="absolute"
...
document.getElementsByName('energMachineDangerControl')[0].align='center';
</script>
