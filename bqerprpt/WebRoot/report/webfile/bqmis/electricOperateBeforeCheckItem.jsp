...
<birt:report id="ElectricOne" reportDesign="bqmis/electricOperateBeforeCheckItem.rptdesign" position="absolute"
...
document.getElementsByName('ElectricOne')[0].align='center';
</script>
