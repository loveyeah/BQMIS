...
<birt:report id="energMachineOpreate" reportDesign="bqmis/energMachineOpreate.rptdesign" position="absolute"
...
document.getElementsByName('energMachineOpreate')[0].align='center';
</script>
