...
<html>
	...
	<head>
		<title>部门职工调整通知单</title>
		<jsp:include page="../../../comm/jsp/commjsp.jsp"></jsp:include>
		<script type="text/javascript" src="../../comm/scripts/Constants.js"></script>
	</head>
	<body>
		<birt:viewer id="removePersonA" top="0" left="0" width="970"
			height="1150" reportDesign="hr\removePersonA.rptdesign"
		...
		<script language="javascript">
	 	document.getElementsByName("removePersonA")[0].align='center';
</script>
	</body>
