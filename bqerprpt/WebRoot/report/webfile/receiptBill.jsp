...
<body>
<div >
<birt:report id="receiptBill" reportDesign="receiptBill.rptdesign" position="absolute"
	        ...
	        <birt:param name="contractNo" value="<%= request.getParameter("contractNo") %>" > </birt:param>  
			 ...
			 <birt:param name="flag" value="<%= request.getParameter("flag") %>" > </birt:param> 
			  <birt:param name="metailIdNotIn" value="<%= request.getParameter("metailIdNotIn") %>" > </birt:param> 
			
		</birt:report>
</div>		
<script  language='javascript'> 
document.getElementsByName('receiptBill')[0].align='center';
</script>
</body>
</html>