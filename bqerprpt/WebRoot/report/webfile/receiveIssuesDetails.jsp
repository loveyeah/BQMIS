...
<body>
<div >
<birt:report id="receiveIssuesDetails" reportDesign="receiveIssuesDetails.rptdesign" position="absolute"
...
document.getElementsByName('receiveIssuesDetails')[0].align='center';
</script>
</body>
</html>