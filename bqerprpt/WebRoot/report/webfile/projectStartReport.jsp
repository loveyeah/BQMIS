...
<body>
<div >
<birt:report id="projectStartReport" reportDesign="projectStartReport.rptdesign" position="absolute"
...
document.getElementsByName('projectStartReport')[0].align='center';
</script>
</body>
</html>