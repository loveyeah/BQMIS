...
BirtNavigationBar.prototype = Object.extend( new AbstractUIComponent( ),
{
	...
	__cb_bind : function( data )
	{
		...
		oImgs[0].style.cursor = "default";
		oImgs[1].style.cursor = (!isFirstPage)? "pointer" : "default";
		oImgs[2].style.cursor = (!isFirstPage)? "pointer" : "default";
		oImgs[3].style.cursor = (!isLastPage)? "pointer" : "default";
		oImgs[4].style.cursor = (!isLastPage)? "pointer" : "default";
		
		oImgs[0].src = this._getImageFileName( this._IMAGE_PRINT, false );
		oImgs[1].src = this._getImageFileName( this._IMAGE_FIRST_PAGE, isFirstPage );
		oImgs[2].src = this._getImageFileName( this._IMAGE_PREVIOUS_PAGE, isFirstPage );
		oImgs[3].src = this._getImageFileName( this._IMAGE_NEXT_PAGE, isLastPage );
		oImgs[4].src = this._getImageFileName( this._IMAGE_LAST_PAGE, isLastPage );		
	},
